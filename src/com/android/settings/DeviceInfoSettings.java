...
public class DeviceInfoSettings extends SettingsPreferenceFragment implements Indexable {
    ...
    private static final String KEY_RADEON_VERSION = "radeon_version";
    ...
    public void onCreate(Bundle icicle) {
        ...
        setValueSummary(KEY_RADEON_VERSION, "ro.radeon.version");
        findPreference(KEY_RADEON_VERSION).setEnabled(true);
